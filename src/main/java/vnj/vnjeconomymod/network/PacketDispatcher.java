package vnj.vnjeconomymod.network;
...
public class PacketDispatcher {
     ...
     */
    private static final SimpleNetworkWrapper dispatcher = NetworkRegistry.INSTANCE.newSimpleChannel(VnjEconomyMod.MOD_ID);
    ...
    public static void registerPackets() {
        PacketDispatcher.registerMessage(MsgUpdatePrice.class);
        PacketDispatcher.registerMessage(MsgVnjemsUserRequests.class);
    }
}